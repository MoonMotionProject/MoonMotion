...
public class ControlsEditor : OdinEditorWindow
{
	...
	[ShowInInspector]
	public List<ControllerOperation> customControllerOperations
	{
		get
		{
			return	customControllerOperations_.isYullAndNotEmpty() ?
						customControllerOperations_ :
						(customControllerOperations_ = Assets.notFromMoonMotionToolkitManifestedOfType<ControllerOperation>());
		}
		private set {}
	}
	...
	public void customControllerOperations_SetSelected(int index)
		=> customControllerOperations_ListItemSelected = customControllerOperations.itemOtherwiseDefault(index);
