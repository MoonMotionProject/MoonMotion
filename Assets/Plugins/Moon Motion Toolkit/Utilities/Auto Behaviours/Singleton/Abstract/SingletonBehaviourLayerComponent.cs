						...
						where SingletonBehaviourT : SingletonBehaviour<SingletonBehaviourT>
{
	...
	public static new void destroy(Func<SingletonBehaviourT, bool> function)
		=> autoBehaviour.destroy(function(singleton));

	public static new void destroy(bool boolean = true)
		=> autoBehaviour.destroy(boolean);
	...
	public static new ComponentT ensured<ComponentT>() where ComponentT : Component
		=> autoBehaviour.ensured<ComponentT>();
	...
	public static new bool anyAutoBehaviours(bool includeInactiveComponents = true)
		=> autoBehaviour.anyAutoBehaviours(includeInactiveComponents);

	public static new bool anyOtherAutoBehaviours(bool includeInactiveComponents = true)
	...
	public static new List<IAutoBehaviour> autoBehaviours(bool includeInactiveComponents = true)
	...
	public static new AutoBehaviour<SingletonBehaviourT> forEach<ComponentT>(Action<ComponentT> action, bool includeInactiveComponents = true) where ComponentT : Component
