...
// Moon Motion Body Transformation
...
public class MoonMotionBodyTransformation : AutoBehaviour<MoonMotionBodyTransformation>
{
	// variables //
	...
	public override void lateUpdate()
    {
		...
		float distanceFromFloor = headsetTransform.localPosition.directionalityWith(Direction.upward) + headAboveEyesHeight;		// determine the distance from the headset to the floor – but offset it by the head above eyes height to fudge for how the part of one's head above their eyes should collide with a ceiling or similar object before their eyes do
