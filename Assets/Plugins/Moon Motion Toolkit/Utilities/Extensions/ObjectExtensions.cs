...
public static class ObjectExtensions
{
	...
	public static Type type_ViaReflection<TObject>(this TObject object_)
		=> object_.GetType();

	// method: return the class name of this given object //
	public static string className_ViaReflection<TObject>(this TObject object_)
	...
	public static TObject print<TObject>(this TObject object_)
		=> object_.after(()=>
	...
	public static TObject after<TObject>(this TObject object_, object whatever)
		=> object_;
	...
	public static TObject after<TObject>(this TObject object_, Action action, bool boolean = true)
	{
	...
	public static TObject forWhich<TObject>(this TObject object_, Action<TObject> action, bool boolean = true)
	{
