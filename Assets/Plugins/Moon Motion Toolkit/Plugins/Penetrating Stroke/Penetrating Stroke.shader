// based on: 'Silhouette.shader' from 'SteamVR' plugin
// custom changes:
// • changed address from "Valve/VR/Silhouette"
...
Shader "Moon Motion Toolkit/Penetrating Stroke"
{
	//-------------------------------------------------------------------------------------------------------------------------------------------------------------
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Outline" "Queue" = "Overlay"  }
		ZTest Always
