...
public static class Asset
{
	...
	#region accessing particular assets
	
	public static string ideeForFirstAsset => ideesForAssets.first();
	public static string pathForFirstAsset => pathForAssetIdee(ideeForFirstAsset);
	#endregion accessing particular assets
	...
	public static AssetT atProjectPathOfType<AssetT>(string projectPath) where AssetT : UnityEngine.Object
		=> AssetDatabase.LoadAssetAtPath<AssetT>(projectPath) as AssetT;

	// method: return the asset of the specified type at the given asset path //
	public static AssetT atAssetPathOfType<AssetT>(string assetPath) where AssetT : UnityEngine.Object
		=> atProjectPathOfType<AssetT>(Project.pathFor(assetPath));

	// method: return the folder asset of the at the given asset path //
	public static UnityEngine.Object folderAtAssetPath(string folderAssetPath)
		=> atAssetPathOfType<UnityEngine.Object>(folderAssetPath);
	#endregion to assets


	#region to asset paths
	
	// method: return the asset path for the asset with the given asset idee //
