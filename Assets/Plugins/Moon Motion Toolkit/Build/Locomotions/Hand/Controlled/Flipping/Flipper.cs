...
public class Flipper : HandLocomotionControlled
{
	...
	private MoonMotionBodyTransformation bodyTransformation;		// connection - auto: the body transformation of this flipper's player's body
	...
	protected override void Awake()
	{
		...
		bodyTransformation = transform.parent.parent.GetComponentInChildren<MoonMotionBodyTransformation>();
